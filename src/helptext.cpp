...
{
	const unsigned int menuInt_entries[MENU_MAX + 1] = { (unsigned int)-1, 7u, 9u, 8u, (unsigned int)-1, (unsigned int)-1, 11u, (unsigned int)-1, (unsigned int)-1, (unsigned int)-1, 6u, 4u, 6u, 7u, 5u };
